  ...
  const baseMessages: ChatMessage[] = [
    {
      ...
      content: [
        ...
        "  1.0 = het is iets dat dit personage in deze situatie zou zeggen.",
        "  0.0 = het stapt uit de rol: het noemt zichzelf een AI of assistent, praat over de oefening,",
        "        het leerdoel of zijn eigen instructies, coacht de gesprekspartner, of weigert",
        "        het gesprek te spelen. Een personage dat een rare vraag simpelweg in de rol",
        "        afwimpelt blijft WEL in de rol.",

...
export const CAO_SYSTEM_INSTRUCTIONS = [
  ...
  "  Let op — dit is géén weigering alleen wanneer de CAO over het gevraagde onderwerp zélf een",
  "  vastgelegd 'nee' uitspreekt (bijvoorbeeld dat een bepaalde toeslag in een gegeven situatie",
  "  niet geldt). Een passage over een ánder onderwerp is geen antwoord op deze vraag: dat is",
  "  niet-gevonden, dus dezelfde exacte zin hierboven, zonder [n].",

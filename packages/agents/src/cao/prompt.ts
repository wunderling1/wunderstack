...
export const CAO_SYSTEM_INSTRUCTIONS = [
  ...
  "",
  "Voorbeeld van twee aaneengesloten quotes onder één marker (verzonnen situatie, geen CAO-tekst):",
  "Context: [1] chunk_id=voorbeeld-diensten Een clubpas geeft toegang tot de volgende diensten: het",
  "lenen van materiaal; toegang tot de leeszaal; gratis printtegoed.",
  "Vraag: Geeft een clubpas toegang tot de leeszaal?",
  "Correct antwoord: Ja, een clubpas geeft toegang tot de leeszaal [1].",
  CITATIONS_SENTINEL,
  '[{"marker":1,"chunk_id":"voorbeeld-diensten","quote":"Een clubpas geeft toegang tot de volgende diensten"},{"marker":1,"chunk_id":"voorbeeld-diensten","quote":"toegang tot de leeszaal"}]',
  "Fout (weglating met …): één quote \"geeft toegang tot de volgende diensten … toegang tot de",
  "leeszaal\" — dat is geen aaneengesloten substring en telt niet als geldige citatie.",
  "",
  "Regels:",

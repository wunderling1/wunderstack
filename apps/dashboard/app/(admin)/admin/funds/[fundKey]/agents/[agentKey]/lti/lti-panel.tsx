...
/** LMS coupling for the exercise agent — lives on Publicatie (S13), not a fourth tab. */
export async function LtiPanel({ fundKey }: { fundKey: string }) {
      ...
      <Card className="flex flex-col gap-4 p-5">
        <div>
          ...
          <p className="mt-1 text-sm text-text-muted">
            ...
            ondoorzichtig pseudoniem. Cijferteruggave is per koppeling opt-in en gebruikt het
            bestaande gewogen cijfer (0–1).
          </p>
        </div>

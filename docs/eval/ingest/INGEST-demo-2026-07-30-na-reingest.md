# Ingest-structuurrapport — `demo` (na-reingest)

> **Gegenereerd:** 2026-07-30T18:21:31.646Z · **Bron:** read-only meting op de opgeslagen chunks
...
|---|---|---|---|
| `demo/cao-fictief.md` | 1 | 2026-07-30 18:21:30 | 32 |
...
|---|---|
| Chunks totaal | 32 |
| Chunk-types | 31 text · 1 table |
| Met `article` | 26/32 (81.3%) |
| Met `source_ref` | 31/32 (96.9%) |
...
| Maat | Waarde |
|---|---|
| Regel-leidende `Artikel N` in de tekst | 26 |
...
| Maat | Waarde |
|---|---|
| Begint mid-zin (D4) | 0/32 (0.0%) |
| Inline `artikel`-kruisverwijzingen | 1 in 1 chunks |

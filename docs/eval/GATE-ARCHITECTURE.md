...
| softFaithfulness | ≥ 0.80 | rate | `[C]` conservatief uit PLAN P5-range 0.80–0.90 (`PLAN-eval-gates.md` §P5); herijk na ≥ 14 nightly-runs. Nulmeting 100%. |
| relevance | ≥ 0.84 *(besluit open: 0.84 vs 0.85 — B1)* | rate | `[E]` gemeten judge-ruis 0.845–0.865 @ 3 samples; 0.84 net onder de spread (PLAN-v3 Fase 14.0 stap 3, `golden-set.REVIEW.md`). B1 = terug naar 0.85? |
...
| completeness | ≥ 0.70 | rate | `[C]` bron niet gevonden → herijk na ≥ 14 nightly-runs. |
| refusalCalibration | ≥ 0.90 | rate | `[C]` bron niet gevonden → herijk na ≥ 14 nightly-runs. Nulmeting 100%. |
